...
function printFileSizes(stats, previousSizeMap) {
  ...
  assets.forEach(asset => {
    ...
    const rightPadding = sizeLength < longestSizeLabelLength
          ? ' '.repeat(longestSizeLabelLength - sizeLength)
          : '';
    console.log(`  ${rightPadding}${sizeLabel}  ${chalk.dim(asset.folder + path.sep)}${chalk.cyan(asset.name)}`);
  });
}
